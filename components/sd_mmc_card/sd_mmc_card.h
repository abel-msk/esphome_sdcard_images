...
namespace esphome
{
    namespace sd_mmc_card
    {
        ...
        public:
            ...
            size_t read_file(std::string const &path, uint8_t *buf, int promise_len);         
            size_t read_file(const char *path, uint8_t *buf, int promise_len);
        ...
        class SdMmcWriteFileAction : public Action<Ts...>
        {
        public:
        ...
        template <typename... Ts>
        class SdMmcAppendFileAction : public Action<Ts...>
        {
        public:
        ...
        template <typename... Ts>
        class SdMmcCreateDirectoryAction : public Action<Ts...>
        {
        public:
        ...
        template <typename... Ts>
        class SdMmcRemoveDirectoryAction : public Action<Ts...>
        {
        public:
        ...
        template <typename... Ts>
        class SdMmcDeleteFileAction : public Action<Ts...>
        {
        public:
